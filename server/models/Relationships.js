...
module.exports = (user, trip, user_trip, applications)=>{
    ...
    user.hasMany(applications, { foreignKey: 'requester_id', sourceKey: 'UserId', as: 'RequestsAsRequester' });
    user.hasMany(applications, { foreignKey: 'driver_id', sourceKey: 'UserId', as: 'RequestsAsDriver' });

    applications.belongsTo(user, { foreignKey: 'requester_id', targetKey: 'UserId', as: 'RequestUser' });
